...
/// </remarks>
internal static class QueryMemoryProcessProbe
{
    public static QueryMemoryLeaseOwner CurrentOwner()
    {
        using var current = Process.GetCurrentProcess();
        return new QueryMemoryLeaseOwner(Environment.MachineName, current.Id, current.StartTime);
    }

    public static bool IsOwnerRunning(QueryMemoryLeaseOwner owner)
    {
