...
public enum QueryMemoryStorageErrorKind
{
...
/// </summary>
[Serializable]
public sealed class QueryMemoryStorageException : Exception
{
    public QueryMemoryStorageException(QueryMemoryStorageErrorKind kind, string message, int? errorCode = null,
    ...
    private QueryMemoryStorageException(SerializationInfo info, StreamingContext context)
        : base(info, context)
    {
        Kind = (QueryMemoryStorageErrorKind)info.GetInt32(nameof(Kind));
    ...
    public QueryMemoryStorageErrorKind Kind { get; }
    ...
    public bool IsTransient => Kind == QueryMemoryStorageErrorKind.Busy;
