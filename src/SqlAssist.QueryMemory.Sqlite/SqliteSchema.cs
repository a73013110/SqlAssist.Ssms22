...
CREATE INDEX IX_FavoriteQueries_ScopeId ON FavoriteQueries(Scope, Server, DatabaseName, FavoriteQueryId DESC);
CREATE INDEX IX_FavoriteQueries_Revision ON FavoriteQueries(CurrentRevisionId);
