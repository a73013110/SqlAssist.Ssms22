...
public sealed class SqliteLeaseTests
{
    ...
    private static QueryMemoryLeaseOwner Owner => new("LIBRARYPC", 4242, Start);
    private static readonly QueryMemoryPolicy DraftsOnly = new(true, false, TimeSpan.FromMinutes(10), false, true);
