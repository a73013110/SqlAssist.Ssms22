...
| F12、定義、失敗註解、執行緒、新查詢 | [F12 指令碼](definition-scripts.md)／[移至定義](go-to-definition.md) |
...
| USE、連結伺服器、OPENQUERY、舊版 SQL、權限、降級 | [連線](metadata-connection.md)／[遠端](metadata-remote.md)／[相容](metadata-compatibility.md) |
